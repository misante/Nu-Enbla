...
export const Email = ({ userCart, totals, deliveryCharge, tax }) => (
  <Html>
    <Head />
    <Preview>Nu Enbla Restaurant Receipt</Preview>

    <Body style={main}>
      <Container style={container}>
        <h1 style={tittleHead}>order confirmation</h1>
        <p style={{ textTransform: "capitalize", textAlign: "center" }}>
          thank you for your order. we will deliver to the soonest possible
        </p>
        <Section>
          <Row>
            {/* <Column>
              <img
                src={"public/nuEnbla_logo1.jpg"}
                alt="logo"
                style={{ minWidth: "50px" }}
                priority={true}
              />
        ...
        <Section style={productTitleTable}>
          <Text style={productsTitle}>ኑ እንብላ ረስቶራንት</Text>
        </Section>
        <Text
          style={{
            fontSize: "4px",
        ...
        <Section>
          {userCart.map((cart) => {
            return (
              <Row key={cart.id} style={{ marginBottom: "5px" }}>
                ...
                <Column style={{ paddingLeft: "22px" }}>
                  <Text style={productTitle}>{cart.productName}</Text>
                  <Link
                    href="http://localhost:3000/restaurant/al-habesha-restaurant"
                    style={productLink}
                ...
                <Column style={productPriceWrapper} align="right">
                  <Text style={productPrice}>{cart.price.toFixed(2)}</Text>
                </Column>
              </Row>
            );
          })}
        ...
        <Section align="right">
          <Row>
            ...
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>{deliveryCharge}</Text>
            </Column>
          </Row>
        </Section>
        <Section align="right">
          <Row>
            <Column style={tableCell} align="right">
              <Text style={productPriceTotal}>Tax</Text>
            </Column>
            <Column style={productPriceVerticalLine}></Column>
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>{tax}</Text>
            </Column>
          </Row>
        </Section>
        <Section align="right">
          <Row>
            ...
            <Column style={productPriceVerticalLine}></Column>
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>{totals}</Text>
            </Column>
          </Row>
        </Section>
        ...
        <Text style={footerCopyright}>
          Copyright © 2024 Nu Enbla Restaurant <br />
